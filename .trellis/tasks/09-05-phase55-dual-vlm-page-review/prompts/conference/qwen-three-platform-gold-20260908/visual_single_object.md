...
- Runner-managed report path: `runs/conference/qwen-three-platform-gold-20260908/visual_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/qwen-three-platform-gold-20260908_conference_context.md`
- `plans/codex_main_venue_qwen-three-platform-gold-20260908.md`
...
Objective:
独立复核真实研究方案与病例横评金标及测试框架，三平台Qwen Flash-Next xhigh，产品独立harness，两维度：方案解构与固定条款病例识别审核；只读临床来源，核对金标完整性、时间节点、书面判断、摘录真实性，禁止修改产品或启动本地模型。
...
- `pi` / `opencode-go` / `muse-spark-1.3-contributor` / effort high
- `pi` / `cms-router` / `cms-model` / effort high
- `pi` / `openai-codex` / `gpt-5.6-luna` / effort max

Output schema:
1. `# Conference Participant Output: qwen-three-platform-gold-20260908 - visual_single_object`
2. `## Boundary Check`
