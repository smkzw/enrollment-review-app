...
- Do not write the runner-managed report path `runs/conference/qwen-bounded-completion-review-20260910/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/qwen-bounded-completion-review-20260910_conference_context.md`
- `plans/codex_main_venue_qwen-bounded-completion-review-20260910.md`
...
Objective:
Read-only review of bounded missing-field repair and local early length guards; inspect frozen source and repeat diagnostic outputs, identify preservation, clinical-warning instability and minimal next verification. No model calls or service control. No implementation.
...
Output schema:
1. `# Conference Output: qwen-bounded-completion-review-20260910 - evidence_single_object`
2. `## Output`
