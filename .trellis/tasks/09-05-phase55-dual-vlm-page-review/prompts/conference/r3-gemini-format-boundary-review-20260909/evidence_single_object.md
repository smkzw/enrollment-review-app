...
- Do not write the runner-managed report path `runs/conference/r3-gemini-format-boundary-review-20260909/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/r3-gemini-format-boundary-review-20260909_conference_context.md`
- `plans/codex_main_venue_r3-gemini-format-boundary-review-20260909.md`
...
Output schema:
1. `# Conference Output: r3-gemini-format-boundary-review-20260909 - evidence_single_object`
2. `## Output`
