# Conference Context: r3-product-local-route-normalizer-review-20260908

Created: 2026-09-08 16:44:03 CST
Objective: 只读审阅新本地主读正式接线与规范化输入保全：检查历史路由、跨本地串行、已核实与待核对输入边界，给出有源码证据的最小修订意见，不判断真实病例、不调用产品模型、不修改源码。
Task type: `C03`
Risk: `high`
...
- Linked execution task: `r3-product-local-route-normalizer-review-20260908`
...
- 2026-09-08 16:44:03 CST: Conference initialized by `hermes_workflow_guard.py init-conference`.
