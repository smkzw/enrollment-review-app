...
- Runner-managed output path: `runs/pi_phase4-evidence-ocr-v2.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/phase4-evidence-ocr-v2_context.md`
...
Output schema:
1. `# Hermes Task Plan: phase4-evidence-ocr-v2`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
