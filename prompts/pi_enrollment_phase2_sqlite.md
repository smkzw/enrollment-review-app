...
- Runner-managed output path: `runs/pi_enrollment_phase2_sqlite.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/enrollment_phase2_sqlite_context.md`
...
Output schema:
1. `# Hermes Task Plan: enrollment_phase2_sqlite`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
