...
- Task id: `phase5-slice58d-v2-target-group-homogeneity-20260825`
- Role id: `worker_02`
...
- Runner-managed report path: `runs/execution/phase5-slice58d-v2-target-group-homogeneity-20260825/worker_02.md`. Never invoke write/edit tools
  to create or update this report file. Return the complete report in your
  final assistant response; the runner persists it. Do not create sibling
  process files.

Initial read set:
- `context/phase5-slice58d-v2-target-group-homogeneity-20260825_execution_context.md`
- `plans/codex_execution_phase5-slice58d-v2-target-group-homogeneity-20260825.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
修复期别适用性紧凑v2输出合同允许异质目标共享一套证据理由的系统缺陷，以确定性目标等价边界防止不同段落被同组掩盖，并用真实D001批次32验证临床语义。

Task:
Execute only this assigned work item: 在app/agents/phase_applicability.py内实现异质目标同组失败关闭及中文原生定向修复提示；不得写D001特异词句，不得改变v1历史读取。
...
Output schema:
1. `# Execution Output: phase5-slice58d-v2-target-group-homogeneity-20260825 - worker_02`
