...
- Runner-managed report path: `runs/execution/phase5-slice58d-v2-target-group-homogeneity-20260825/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 只读审计v2分组输入、输出、扩展、门禁与提示词，提出最小且通用的确定性目标同组等价条件，明确对现有v1兼容和输出预算的影响。
...
Output schema:
1. `# Execution Output: phase5-slice58d-v2-target-group-homogeneity-20260825 - worker_01`
