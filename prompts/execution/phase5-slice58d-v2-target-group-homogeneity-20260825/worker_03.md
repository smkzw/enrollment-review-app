...
- Runner-managed report path: `runs/execution/phase5-slice58d-v2-target-group-homogeneity-20260825/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 补充合成回归覆盖不同摘录/标题/表格上下文/期别范围不得同组和真正等价目标可同组，并只读重跑D001当前批次32进行临床语义核对。
...
Output schema:
1. `# Execution Output: phase5-slice58d-v2-target-group-homogeneity-20260825 - worker_03`
