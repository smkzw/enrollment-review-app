...
- Runner-managed report path: `runs/execution/phase4-real-project-entry-20260821/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现中文原生的受试者新增与删除入口、确认和错误恢复
...
Output schema:
1. `# Execution Output: phase4-real-project-entry-20260821 - worker_02`
