...
- Runner-managed report path: `runs/execution/phase4-real-project-entry-20260821/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 审计V2新增/删除受试者与审核节点创建合同，定位缺失闭环
...
Output schema:
1. `# Execution Output: phase4-real-project-entry-20260821 - worker_01`
