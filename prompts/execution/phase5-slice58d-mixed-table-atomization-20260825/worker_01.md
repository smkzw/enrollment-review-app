...
- Runner-managed report path: `runs/execution/phase5-slice58d-mixed-table-atomization-20260825/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实施通用混合期别表格行原子化，保持普通同范围行聚合和全部表格来源上下文。
...
Output schema:
1. `# Execution Output: phase5-slice58d-mixed-table-atomization-20260825 - worker_01`
