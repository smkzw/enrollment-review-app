...
- Runner-managed report path: `runs/execution/phase5-slice58l-d001-six-package-semantic-baseline-20260826/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 核对并最小化复用既有清单、计划和执行服务，生成只含六个已冻结代表包且身份一致的受控执行输入；不得改动临床源文件。
...
Output schema:
1. `# Execution Output: phase5-slice58l-d001-six-package-semantic-baseline-20260826 - worker_01`
