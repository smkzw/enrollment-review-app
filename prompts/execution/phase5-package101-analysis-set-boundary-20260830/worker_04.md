...
- Runner-managed report path: `runs/execution/phase5-package101-analysis-set-boundary-20260830/worker_04.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 审阅拟定确定性契约与最小测试覆盖，列出必须锁定的不变量和反例；不得修改冻结基线或临床源文件。
...
Output schema:
1. `# Execution Output: phase5-package101-analysis-set-boundary-20260830 - worker_04`
