...
- Runner-managed report path: `runs/execution/phase5-slice58-runtime-bootstrap-20260824/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现 Evidence Normalizer 专属运行配置的确定性注册和精确选择，配置变化追加新身份、合同漂移失败关闭，不修改临床规则。
...
Output schema:
1. `# Execution Output: phase5-slice58-runtime-bootstrap-20260824 - worker_02`
