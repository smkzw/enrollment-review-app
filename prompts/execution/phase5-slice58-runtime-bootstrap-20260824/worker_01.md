...
- Task id: `phase5-slice58-runtime-bootstrap-20260824`
- Role id: `worker_01`
...
- Runner-managed report path: `runs/execution/phase5-slice58-runtime-bootstrap-20260824/worker_01.md`. Never invoke write/edit tools
  to create or update this report file. Return the complete report in your
  final assistant response; the runner persists it. Do not create sibling
  process files.

Initial read set:
- `context/phase5-slice58-runtime-bootstrap-20260824_execution_context.md`
- `plans/codex_execution_phase5-slice58-runtime-bootstrap-20260824.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
为 Phase 5.8 建立 Evidence Normalizer 的生产可用、不可变且可验证的运行配置注册，确保全新数据库能够实际启动规范化任务，同时不误选其他 Agent 的配置。

Task:
Execute only this assigned work item: 审计现有 PromptVersion、ModelConfig、应用 lifespan 与 FactNormalizationCommandService 的真实运行路径，确认全新数据库配置缺口及共享模式。
...
Output schema:
1. `# Execution Output: phase5-slice58-runtime-bootstrap-20260824 - worker_01`
