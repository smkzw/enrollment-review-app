...
- Runner-managed report path: `runs/execution/phase5-slice58-runtime-bootstrap-20260824/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 补充全新应用启动、不可变身份、配置变化追加、错误配置拒绝及命令路径的聚焦回归测试，并执行相关测试。
...
Output schema:
1. `# Execution Output: phase5-slice58-runtime-bootstrap-20260824 - worker_03`
