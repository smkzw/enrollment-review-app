...
- Runner-managed report path: `runs/execution/phase5-slice58d-structural-phase-inheritance-20260825/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 追踪正文标题层级与表格上位上下文，实施最小通用根因修复，不引入项目特异规则。
...
Output schema:
1. `# Execution Output: phase5-slice58d-structural-phase-inheritance-20260825 - worker_01`
