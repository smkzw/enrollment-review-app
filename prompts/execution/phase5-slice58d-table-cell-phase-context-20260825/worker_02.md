...
- Runner-managed report path: `runs/execution/phase5-slice58d-table-cell-phase-context-20260825/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 建立同一表格单元格内明确期别段标题的窄范围上下文切换，后续段落继承最近阶段，普通叙述期别提及不得扩散。
...
Output schema:
1. `# Execution Output: phase5-slice58d-table-cell-phase-context-20260825 - worker_02`
