...
- Runner-managed report path: `runs/execution/phase5-slice58d-table-cell-phase-context-20260825/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 增加合成反例与真实D001只读重建核对，量化单元、待处置和批次数，检查原批次32及表5并验证源文件未变。
...
Output schema:
1. `# Execution Output: phase5-slice58d-table-cell-phase-context-20260825 - worker_03`
