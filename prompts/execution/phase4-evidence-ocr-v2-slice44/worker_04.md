...
- Runner-managed report path: `runs/execution/phase4-evidence-ocr-v2-slice44/worker_04.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: WP-44D：实现中文原生 OCR 核对闭环前端并完成宽屏交互验证

Do not begin unless the Codex review explicitly records WP-44A, WP-44B, and WP-44C acceptance. If any release gate is absent, stop without modifying files and report the missing gate.
...
Output schema:
1. `# Execution Output: phase4-evidence-ocr-v2-slice44 - worker_04`
