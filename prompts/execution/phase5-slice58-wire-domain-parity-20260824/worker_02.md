...
- Runner-managed report path: `runs/execution/phase5-slice58-wire-domain-parity-20260824/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 将逻辑节点按 NOT 与 ALL/ANY 的不同元数约束拆分或等价表达，保持统一图身份、循环/孤儿/共享子节点校验与无损水合。
...
Output schema:
1. `# Execution Output: phase5-slice58-wire-domain-parity-20260824 - worker_02`
