...
- Runner-managed report path: `runs/execution/phase5-slice58-wire-domain-parity-20260824/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 增加独立 Schema 与水合回归覆盖真实反例、合法单段/多段定位、NOT=1、ALL/ANY不少于2，并运行聚焦及协议测试。
...
Output schema:
1. `# Execution Output: phase5-slice58-wire-domain-parity-20260824 - worker_03`
