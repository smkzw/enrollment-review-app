...
- Runner-managed report path: `runs/execution/phase5-slice58d-compact-phase-wire-20260825/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 增加独立边界测试：排序、重复、身份漂移、漏目标、异质组、证据归属，以及 v1 历史兼容或明确迁移。
...
Output schema:
1. `# Execution Output: phase5-slice58d-compact-phase-wire-20260825 - worker_02`
