...
- Runner-managed report path: `runs/execution/phase5-slice58d-compact-phase-wire-20260825/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 设计并实现紧凑 v2 provider wire、严格分组校验及确定性逐目标展开，保留现有领域结果和 gate。
...
Output schema:
1. `# Execution Output: phase5-slice58d-compact-phase-wire-20260825 - worker_01`
