...
- Runner-managed report path: `runs/execution/phase5-package100-phase-segment-inheritance-20260830/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 重建 D001 II 当前冻结基线，比较全部结构单元、目标和包边界，确认已验收 Package 1-99 不被静默改写。
...
Output schema:
1. `# Execution Output: phase5-package100-phase-segment-inheritance-20260830 - worker_03`
