...
- Runner-managed report path: `runs/execution/phase5-slice58f-phase-context-dedup-20260826/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现上下文正文单次呈现、上下文包只保留类型与索引的通用提示压缩，并更新相关合同说明，不加入项目特异规则。
...
Output schema:
1. `# Execution Output: phase5-slice58f-phase-context-dedup-20260826 - worker_02`
