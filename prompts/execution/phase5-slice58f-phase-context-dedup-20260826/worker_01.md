...
- Task id: `phase5-slice58f-phase-context-dedup-20260826`
- Role id: `worker_01`
...
- Runner-managed report path: `runs/execution/phase5-slice58f-phase-context-dedup-20260826/worker_01.md`. Never invoke write/edit tools
  to create or update this report file. Return the complete report in your
  final assistant response; the runner persists it. Do not create sibling
  process files.

Initial read set:
- `context/phase5-slice58f-phase-context-dedup-20260826_execution_context.md`
- `plans/codex_execution_phase5-slice58f-phase-context-dedup-20260826.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
消除期别语义Agent提示中上下文单元的重复正文注入，在保留完整来源闭包、索引可追溯性和中文临床语义合同的前提下显著缩短真实D001批次输入，并验证技术与临床语义不回退。

Task:
Execute only this assigned work item: 只读审计当前context_units与context_packets重复渲染的合同边界，提出不丢来源、不改变身份与水合逻辑的最小压缩方案。
...
Output schema:
1. `# Execution Output: phase5-slice58f-phase-context-dedup-20260826 - worker_01`
