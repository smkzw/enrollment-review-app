...
- Runner-managed report path: `runs/execution/enrollment_phase2_sqlite/manager.md`. Never invoke write/edit tools
...
- `runs/execution/enrollment_phase2_sqlite/worker_01.md`
- `runs/execution/enrollment_phase2_sqlite/worker_02.md`
- `runs/execution/enrollment_phase2_sqlite/worker_03.md`
...
Output schema:
1. `# Execution Output: enrollment_phase2_sqlite - complex_manager_cursor`
