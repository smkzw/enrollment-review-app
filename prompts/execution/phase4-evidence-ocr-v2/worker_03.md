...
- Runner-managed report path: `runs/execution/phase4-evidence-ocr-v2/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Slice 4.5-4.6：宽屏证据体验、恢复、三路独立视觉试用、回归与清理
...
Output schema:
1. `# Execution Output: phase4-evidence-ocr-v2 - worker_03`
