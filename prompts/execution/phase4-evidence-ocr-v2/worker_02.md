...
- Runner-managed report path: `runs/execution/phase4-evidence-ocr-v2/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Slice 4.2-4.4：上传预览、持久OCR、定位风险校对与激活闭环
...
Output schema:
1. `# Execution Output: phase4-evidence-ocr-v2 - worker_02`
