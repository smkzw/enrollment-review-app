...
- Runner-managed report path: `runs/execution/phase5-slice58r2-provenance-and-five-package-semantic-validation-20260827/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 只读核查当前产品内置期别语义模型配置、oMLX运行入口、健康与模型身份验证方法、实际执行参数及速度质量测量字段，输出最小可复现实行命令，不调用模型。
...
Output schema:
1. `# Execution Output: phase5-slice58r2-provenance-and-five-package-semantic-validation-20260827 - worker_02`
