...
- Runner-managed report path: `runs/execution/phase5-env-preflight-20260901/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 独立审查实现与测试，重点验证 worktree 进程确实获得 DECONSTRUCT_GLM_API_KEY、声明路由等于可执行路由、故障不泄密且不误触测试网络。
...
Output schema:
1. `# Execution Output: phase5-env-preflight-20260901 - worker_03`
