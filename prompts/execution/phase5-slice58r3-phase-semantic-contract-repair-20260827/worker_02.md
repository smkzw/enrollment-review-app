...
- Runner-managed report path: `runs/execution/phase5-slice58r3-phase-semantic-contract-repair-20260827/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 审阅并收紧确定性规则标题族关联，区分目标相关证据与可传播期别范围证据，禁止共同上层标题或普通提及造成跨规则广播。
...
Output schema:
1. `# Execution Output: phase5-slice58r3-phase-semantic-contract-repair-20260827 - worker_02`
