...
- Runner-managed report path: `runs/execution/phase5-protocol-control-recovery-20260831/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 新增确定性测试，证明中断动态步骤按租约恢复、已完成发现批次不重复执行、来源文件不被重新解析。
...
Output schema:
1. `# Execution Output: phase5-protocol-control-recovery-20260831 - worker_02`
