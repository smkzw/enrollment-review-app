...
- Runner-managed report path: `runs/conference/phase1_5_agent_monitor_visual/visual_pi_k3_256k.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/phase1_5_agent_monitor_visual_conference_context.md`
- `plans/codex_main_venue_phase1_5_agent_monitor_visual.md`
...
Objective:
以懒惰但专业、视觉敏感、不熟悉电脑和AI的中文资深医学监查员身份，在真实浏览器自由探索入排审核Phase 1原型，端到端审查14项任务、临床信息可读性、证据回源、Patient Profile、中文交互、响应式与康哲交互轨视觉，明确已验证能力与未实施能力并追查系统性根因
...
Output schema:
1. `# Conference Participant Output: phase1_5_agent_monitor_visual - visual_pi_k3_256k`
2. `## Boundary Check`
