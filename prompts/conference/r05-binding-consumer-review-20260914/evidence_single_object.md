...
- Runner-managed report path: `runs/conference/r05-binding-consumer-review-20260914/evidence_single_object.md`. Never invoke write/edit tools
  to create or update this report file; return the complete report in your
  final assistant response and let the bounded runner persist it. Do not create
  sibling output files.

Initial read set:
- `context/r05-binding-consumer-review-20260914_conference_context.md`
- `plans/codex_main_venue_r05-binding-consumer-review-20260914.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
Review receipt-derived frozen calculation selections: artifact vs logical hashes, actual persisted authorization, semantic rejection and population scope, immutable source equivalence, both official and control selection integration. Read-only source review, no tests/model/DB calls.
...
Output schema:
1. `# Conference Output: r05-binding-consumer-review-20260914 - evidence_single_object`
2. `## Output`
