...
- Runner-managed report path: `runs/conference/r3-targeted-durable-review-20260906/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/r3-targeted-durable-review-20260906_conference_context.md`
- `plans/codex_main_venue_r3-targeted-durable-review-20260906.md`
...
Objective:
只读审查两轮辅助原件复核：持久上限、来源绑定、无自动事实采信、失败与缺研究者判断分离。禁止修改应用或原始资料。
...
Output schema:
1. `# Conference Participant Output: r3-targeted-durable-review-20260906 - general_single_object`
2. `## Boundary Check`
