...
- Runner-managed report path: `runs/conference/phase4-catalog-evidence-uat-r2/visual_pi_k3_256k.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Objective:
以真实医学监查人员视角验证 Phase 4 正式模式的项目、受试者、资料快照、OCR 校对与原始证据定位全流程
...
Output schema:
1. `# Conference Participant Output: phase4-catalog-evidence-uat-r2 - visual_pi_k3_256k`
2. `## Boundary Check`
