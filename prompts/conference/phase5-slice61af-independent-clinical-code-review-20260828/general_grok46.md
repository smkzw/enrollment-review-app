...
- Role description: participant 2 for complex, logic-heavy, evidence-sensitive, artifact-heavy, and high-risk contradiction review; Grok Build medium -> Pi/Cursor Grok medium -> CMS Router
...
- Runner-managed report path: `runs/conference/phase5-slice61af-independent-clinical-code-review-20260828/general_grok46.md`. Never invoke write/edit tools
...
- `pi` / `cms-router` / `minimax-m3` / effort high

Output schema:
1. `# Conference Participant Output: phase5-slice61af-independent-clinical-code-review-20260828 - general_grok46`
2. `## Boundary Check`
