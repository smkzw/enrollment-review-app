...
- Runner-managed report path: `runs/conference/phase4-wp44c-final-acceptance/general_grok46.md`. Never invoke write/edit tools
...
Initial read set:
- `AGENTS.md`
- `context/phase4-wp44c-final-acceptance_conference_context.md`
- `plans/codex_main_venue_phase4-wp44c-final-acceptance.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
独立验收 Phase 4 Slice 4.4 WP-44C 后端接口与事务语义，决定是否解锁 WP-44D
...
Output schema:
1. `# Conference Participant Output: phase4-wp44c-final-acceptance - general_grok46`
2. `## Boundary Check`
