...
Respect applicable higher-priority/global/project instructions. Read-only adviser; no recursive delegation, pi-worker, memory/history, source writes, tests/imports, browser/DB/models. Return report only, runner persists it.
Use this bounded assignment and output schema without overriding those instructions.
Do not start conferences, do not rediscover tools, and do not scan the internet unless this assignment says so.
Read applicable instructions as needed; no personal harness configuration or secrets.
...
- Runner-managed report path: `runs/conference/r05-retest-design-20260915/evidence_single_object.md`. Never invoke write/edit tools
  to create or update this report file; return the complete report in your
  final assistant response and let the bounded runner persist it. Do not create
  sibling output files.

Initial read set:
- `context/r05-retest-design-20260915_conference_context.md`
- `plans/codex_main_venue_r05-retest-design-20260915.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
Source-grounded design for conditional clinical retest relation and consumption within existing product architecture; not a new framework, no runtime or staged tests
...
Output schema:
1. `# Conference Output: r05-retest-design-20260915 - evidence_single_object`
2. `## Output`
