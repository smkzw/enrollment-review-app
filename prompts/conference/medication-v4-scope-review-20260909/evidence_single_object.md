...
- Do not write the runner-managed report path `runs/conference/medication-v4-scope-review-20260909/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/medication-v4-scope-review-20260909_conference_context.md`
- `plans/codex_main_venue_medication-v4-scope-review-20260909.md`
...
Objective:
只读审阅用药分项v4跨受试者失败与通用用途边界：明确未药物干预却提取疾病日期为use_start；挑战最小修订方案，防止为无药名但明确使用的记录误删事实，不作临床或产品接入验收。
...
Output schema:
1. `# Conference Output: medication-v4-scope-review-20260909 - evidence_single_object`
2. `## Output`
