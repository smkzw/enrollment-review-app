...
- Do not write the runner-managed report path `runs/conference/enrollment-visual-input-review-20260916/evidence_single_object.md`; return the complete report for the runner.

Initial read set:
- `context/enrollment-visual-input-review-20260916_conference_context.md`
- `plans/codex_main_venue_enrollment-visual-input-review-20260916.md`
...
Output schema:
1. `# Conference Output: enrollment-visual-input-review-20260916 - evidence_single_object`
2. `## Output`
