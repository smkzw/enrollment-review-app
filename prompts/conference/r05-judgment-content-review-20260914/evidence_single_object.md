...
- Do not write the runner-managed report path `runs/conference/r05-judgment-content-review-20260914/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/r05-judgment-content-review-20260914_conference_context.md`
- `plans/codex_main_venue_r05-judgment-content-review-20260914.md`
...
Objective:
Read-only review of written-judgment content producer/receipt chain and minimal safe integration into formal calculation; identify concrete defects and whether qualification/content can share one call without losing separate evidence.
...
Output schema:
1. `# Conference Output: r05-judgment-content-review-20260914 - evidence_single_object`
2. `## Output`
