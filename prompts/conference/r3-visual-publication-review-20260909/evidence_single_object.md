...
- Do not write the runner-managed report path `runs/conference/r3-visual-publication-review-20260909/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/r3-visual-publication-review-20260909_conference_context.md`
- `plans/codex_main_venue_r3-visual-publication-review-20260909.md`
...
Objective:
只读审阅新视觉摘录来源从双读对账到Normalizer及正式事实发布、回放、原件回查的完整接线，识别实际缺陷与最小修复建议，不修改文件不读取凭据不调用病例模型。
...
Output schema:
1. `# Conference Output: r3-visual-publication-review-20260909 - evidence_single_object`
2. `## Output`
