...
- Do not write the runner-managed report path `runs/conference/r3-visual-source-integration-review-20260909/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/r3-visual-source-integration-review-20260909_conference_context.md`
- `plans/codex_main_venue_r3-visual-source-integration-review-20260909.md`
...
Objective:
独立审阅新增视觉来源合同及其正式接线方案：不以OCR为图像事实权威，不破坏既有修订/覆盖，不形成来源验证旁路。给出最小完整接线边界和实质缺陷。
...
Output schema:
1. `# Conference Output: r3-visual-source-integration-review-20260909 - evidence_single_object`
2. `## Output`
