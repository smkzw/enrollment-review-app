...
- Runner-managed report path: `runs/conference/phase3-slice1-acceptance/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: phase3-slice1-acceptance - general_grok46`
2. `## Boundary Check`
