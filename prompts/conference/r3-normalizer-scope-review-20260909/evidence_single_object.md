...
- Do not write the runner-managed report path `runs/conference/r3-normalizer-scope-review-20260909/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/r3-normalizer-scope-review-20260909_conference_context.md`
- `plans/codex_main_venue_r3-normalizer-scope-review-20260909.md`
...
Objective:
Review verified-observations-only normalizer scope with deterministic pending retention; find clinical/source loss and minimum safe integration requirements
...
Output schema:
1. `# Conference Output: r3-normalizer-scope-review-20260909 - evidence_single_object`
2. `## Output`
