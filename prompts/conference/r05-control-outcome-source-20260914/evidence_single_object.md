...
- Runner-managed report path: `runs/conference/r05-control-outcome-source-20260914/evidence_single_object.md`. Never invoke write/edit tools
  to create or update this report file; return the complete report in your
  final assistant response and let the bounded runner persist it. Do not create
  sibling output files.

Initial read set:
- `context/r05-control-outcome-source-20260914_conference_context.md`
- `plans/codex_main_venue_r05-control-outcome-source-20260914.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
Read-only source review of frozen control outcome projection and unresolved official predicates; challenge modality, branch attribution, unknown vs missing, source identity and formal publication boundaries. No tests or product calls.
...
Output schema:
1. `# Conference Output: r05-control-outcome-source-20260914 - evidence_single_object`
2. `## Output`
