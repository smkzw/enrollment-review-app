...
Preserve higher-priority instructions, confidentiality and explicit delegated boundaries; do not claim final acceptance.
Follow this bounded assignment and output schema without expanding its scope.
...
- Do not write the runner-managed report path `runs/conference/r05-batch-ocr-review-20260915/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/r05-batch-ocr-review-20260915_conference_context.md`
- `plans/codex_main_venue_r05-batch-ocr-review-20260915.md`
...
Objective:
只读核对批量重新识别的版本保留、幂等、取消恢复及前端衔接，不运行阶段测试或产品模型
...
Output schema:
1. `# Conference Output: r05-batch-ocr-review-20260915 - evidence_single_object`
2. `## Output`
