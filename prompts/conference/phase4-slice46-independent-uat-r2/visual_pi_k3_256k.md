...
- Runner-managed report path: `runs/conference/phase4-slice46-independent-uat-r2/visual_pi_k3_256k.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/phase4-slice46-independent-uat-r2_conference_context.md`
- `plans/codex_main_venue_phase4-slice46-independent-uat-r2.md`
...
Objective:
三种指定视觉模型在清洁真实持久化环境中独立完成 Phase 4 证据工作流端到端试用并追查共同根因
...
Output schema:
1. `# Conference Participant Output: phase4-slice46-independent-uat-r2 - visual_pi_k3_256k`
2. `## Boundary Check`
