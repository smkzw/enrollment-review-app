...
- Do not write the runner-managed report path `runs/conference/written-judgment-scope-20260910/evidence_single_object.md`; return the complete report and let the runner persist it.
- Do not claim final clinical, regulatory, visual, browser, or user-facing acceptance authority; Codex remains final authority.

Initial read set:
- `context/written-judgment-scope-20260910_conference_context.md`
- `plans/codex_main_venue_written-judgment-scope-20260910.md`
...
Objective:
只读审阅正式研究者书面判断来源覆盖合同，区分已核实阳性证明、未核实与完整范围缺失，给出最小可实施方案，不改代码不调用产品模型
...
Output schema:
1. `# Conference Output: written-judgment-scope-20260910 - evidence_single_object`
2. `## Output`
