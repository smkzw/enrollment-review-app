...
- Runner-managed report path: `runs/conference/phase5-slice61bj-vital-sign-parent-clinical-review/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/phase5-slice61bj-vital-sign-parent-clinical-review_conference_context.md`
- `plans/codex_main_venue_phase5-slice61bj-vital-sign-parent-clinical-review.md`
...
Output schema:
1. `# Conference Participant Output: phase5-slice61bj-vital-sign-parent-clinical-review - general_single_object`
2. `## Boundary Check`
