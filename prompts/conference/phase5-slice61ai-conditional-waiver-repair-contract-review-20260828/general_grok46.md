...
- Runner-managed report path: `runs/conference/phase5-slice61ai-conditional-waiver-repair-contract-review-20260828/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: phase5-slice61ai-conditional-waiver-repair-contract-review-20260828 - general_grok46`
2. `## Boundary Check`
