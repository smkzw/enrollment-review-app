...
- Runner-managed output path: `runs/pi_enrollment_review_v2_build.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/enrollment_review_v2_build_context.md`
...
Output schema:
1. `# Hermes Task Plan: enrollment_review_v2_build`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
