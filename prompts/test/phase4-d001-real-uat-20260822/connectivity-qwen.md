...
- `prompts/test/phase4-d001-real-uat-20260822/connectivity-qwen.md`

Runner-managed output path: `runs/test/phase4-d001-real-uat-20260822/connectivity/qwen.md`.
