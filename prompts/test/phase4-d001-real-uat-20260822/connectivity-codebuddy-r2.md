...
- `prompts/test/phase4-d001-real-uat-20260822/connectivity-codebuddy-r2.md`

Runner-managed output path: `runs/test/phase4-d001-real-uat-20260822/r2/connectivity/codebuddy.md`.

Open `http://127.0.0.1:4261/#/subjects` in a real browser at 1920x1080. Verify all five items with actual tool evidence: local HTTP page load, rendered-page visual inspection, browser interaction, screenshot creation under `runs/test/phase4-d001-real-uat-20260822/r2/codebuddy/connectivity/`, and file-chooser capability by selecting this prompt file without submitting it. Confirm the D001-02 II phase project is visible and the subject list is empty. Return a concise Chinese table and end with exactly `CONNECTIVITY_OK` or `CONNECTIVITY_BLOCKED`. Do not continue into the full UAT.
