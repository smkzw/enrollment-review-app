...
- Runner-managed output path: `runs/pi_phase4-d001-real-independent-uat-20260822.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/phase4-d001-real-independent-uat-20260822_context.md`
...
Output schema:
1. `# Hermes Task Plan: phase4-d001-real-independent-uat-20260822`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
