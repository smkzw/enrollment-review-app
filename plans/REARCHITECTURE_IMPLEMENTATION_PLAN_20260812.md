...
5. 定义CSS设计token、信息密度、键盘操作、证据查看器、宽屏/窄屏降级和页面级滚动合同。
...
9. 在1280/1440/1920桌面和代表性窄屏、100%/150%/200%缩放完成Playwright截图、交互、键盘和axe-core检查。
...
| UI/视觉/可访问性 | Playwright截图 + axe-core + 键盘 | 1280/1440/1920、窄屏、100/150/200%缩放、长文本、空/错/加载/stale | 页面级无横向滚动；0个critical axe错误；键盘可完成主路径 |
