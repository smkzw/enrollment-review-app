...
- 2026-09-22 02:20 守望窗口延长至14天（长周期守望，恢复即自动跑全链）；
  09-25 20:20 的定时核查已同步更新（移除已被取代的旧任务重试步骤，
  改为核对守望链结果+投影记录）。规模驱动脚本已补筛选节点选择。

- 2026-09-22 03:2x 规模驱动脚本契约干跑核查完成：7个API调用（建受试者/
  节点列表/上传预览/提交/页判读/事实重整/投影）与实测接口契约逐一比对
