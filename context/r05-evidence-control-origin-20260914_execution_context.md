# Execution Context: r05-evidence-control-origin-20260914

Created: 2026-09-14 03:48:01 CST
Objective: 补齐资料要求第三来源的存储字段与迁移草案；保留旧数据，不运行数据库、测试或产品模型
Task type: `E03`
Risk: `high`
...
1. 仅修改EvidenceRequirementRecord来源列和新增0025迁移草案，允许只读相邻源码，主线程负责仓储发布与投影
