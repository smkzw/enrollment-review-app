# Execution Context: r3-visual-source-validation-cost-20260909

Created: 2026-09-09 16:48:48 CST
Objective: 消除事实整理阶段重复的原件来源核验成本，保持相同来源验证、完整性及临床输出
Task type: `E03`
Risk: `high`
...
1. 定位并最小修复视觉定位在单事务内重复全修订核验，补充污染及结果等价回归，不调用模型不改原库
