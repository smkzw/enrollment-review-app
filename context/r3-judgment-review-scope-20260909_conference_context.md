# Conference Context: r3-judgment-review-scope-20260909

Created: 2026-09-09 12:01:36 CST
Objective: 只读审阅研究者书面判断的证据范围与两轮手写复核最小修订方案；区分读取未核实与确无记录，不作病例判定、不修改源码、不运行模型识别或横评。
Task type: `C03`
Risk: `high`
...
- Linked execution task: `r3-judgment-review-scope-20260909`
...
- 2026-09-09 12:01:36 CST: Conference initialized by `hermes_workflow_guard.py init-conference`.
