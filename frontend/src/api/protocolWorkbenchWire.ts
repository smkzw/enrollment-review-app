...
export interface WireIdentityDecision {
  ...
  official_date_precision: string | null;
...
export interface WireIdentityReviewResponse {
  ...
  phase_candidates: ReadonlyArray<Record<string, unknown>>;
  metadata_candidates: ReadonlyArray<Record<string, unknown>>;
  metadata_conflicts: ReadonlyArray<Record<string, unknown>>;
}
