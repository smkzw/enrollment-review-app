...
REASON_GAPS = {
    ...
    "action_completion_source_unverified": GapType.OBSERVATION_UNVERIFIED,
    ...
    "proposition_current_node_unverified": GapType.OBSERVATION_UNVERIFIED,
    "proposition_current_node_mismatch": GapType.OBSERVATION_UNVERIFIED,
